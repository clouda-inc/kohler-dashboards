...
const OrdersTable: React.FC<OrdersTableProps> = ({ orders, sortBy, sortOrder, onSort }) => {
    const columns = [
        ...
        <div style={{ overflowX: 'auto', marginBottom: '20px' }}>
            ...
            >
                        ...
                        {columns.map(column => (
                            <th
                                ...
                                style={{
                                    ...
                                    fontWeight: 'bold',
                                    userSelect: 'none',
                                    backgroundColor: sortBy === column.key ? '#e8e8e8' : 'transparent',
                                }}
                            >
                                {column.label}
                ...
                <tbody>
                    {orders.length === 0 ? (
                        <tr>
                            <td colSpan={columns.length} style={{ padding: '12px', textAlign: 'center', color: '#999' }}>
                                No orders found
                            </td>
                        </tr>
                    ) : (
